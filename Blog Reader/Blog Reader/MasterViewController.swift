...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //this URL is https, doesnt need INFO.PLIST stuff
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCx_DPyS50Zdcv2uQUyGxytLjoSmJfb3qc")!
                            ...
                            if results.count > 0 {
                                ...
                                for result in results {
                                    ...
                                    do {
                                        ...
                                        print("Couldnt delete specific result")
                                    }
                                }
                            }
                        }
